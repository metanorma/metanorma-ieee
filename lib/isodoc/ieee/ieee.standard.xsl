...
 </xsl:text> <!-- to add distance between dt and dd -->
	...
	<xsl:template xmlns:redirect="http://xml.apache.org/xalan/redirect" name="showFigureKey">
	...
	<xsl:template xmlns:redirect="http://xml.apache.org/xalan/redirect" name="getImageSrc">
		<xsl:choose>
