...
RSpec.describe IsoDoc do
  ...
  it "places bibliography bracket information footnote after first occurence of [B...]" do
    input = <<~INPUT
            ...
            <p id='_'>
              <eref bibitemid="ISO16634"/>
              <eref type='inline' bibitemid='ISO16634' citeas='ISO 639:1967'/>
              <eref type='inline' bibitemid='ISO16634' citeas='[B1]'/>
              <eref type='inline' bibitemid='ISO16635' citeas='REF4'>this is renderable text</eref>
              <eref type='inline' bibitemid='ISO16635' citeas='REF4'/>
              <eref type='inline' bibitemid='ISO16635' citeas='[B1]'/>
            </p>
          </clause>
        </sections>
        <bibliography>
