  ...
  it "processes default metadata" do
    ...
    output =
      { abbrev_doctitle: "Draft Rec. Prac. for Main Title<br/>in multiple lines",
        ...
        amd: "A1",
        announceddate: "XXX",
        authorizer: ["Institute of Electrical and Electronic Engineers"],
        ...
        lang: "en",
        obsoleteddate: "XXX",
        "presentation_metadata_coverpage-statement": ["IEEE SA Industry Affiliate Network (IAN) base specification contributed by the Spatial Web Foundation"],
        program: "HIJ",
