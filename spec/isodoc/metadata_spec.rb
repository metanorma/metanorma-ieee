...
RSpec.describe Metanorma::Ieee do
  ...
  it "processes default metadata" do
    ...
    expect(metadata(csdc.info(docxml, nil)))
      .to be_equivalent_to({:abbrev_doctitle=>"Draft Rec. Prac. for Main Title<br/>in multiple lines",
                            :accesseddate=>"XXX",
                            :adapteddate=>"XXX",
                            :agency=>"IEEE",
                            :amd=>"A1",
  ...
  it "processes ICAP, ICR metadata" do
    ...
    expect(metadata(csdc.info(docxml, nil)))
      .to be_equivalent_to({:abbrev_doctitle=>"Draft ??? for Main Title<br/>in multiple lines",
                            :accesseddate=>"XXX",
                            :adapteddate=>"XXX",
                            :agency=>"IEEE",
                            :amd=>"A1",
