...
RSpec.describe Metanorma::Ieee do
  ...
  it "footnotes withdrawn IEEE references" do
    ...
    output = <<~OUTPUT
      <bibliography>
        <references id="_" normative="true" obligation="informative">
      <title id="_">Normative references</title><p id="_">The following referenced documents are indispensable for the application of this document (i.e., they must be understood and used, so each referenced document is cited in text and its relationship to this document is explained). For dated references, only the edition cited applies. For undated references, the latest edition of the referenced document (including any amendments or corrigenda) applies.</p><bibitem anchor="ref1" id="_">
        ...
        <references id="_" normative="false" obligation="informative">
      <title id="_">Bibliography</title><p id="_">Bibliographical references are resources that provide additional or helpful material but do not need to be understood or used to implement this standard. Reference to these resources is made for informational use only.</p><bibitem id="_" type="standard" anchor="ref4">
        <fetched/>

      <title type="main">IEEE Standard Pulse Terms and Definitions</title>

        <uri type="src">https://ieeexplore.ieee.org/document/29015</uri>
        <docidentifier type="IEEE" primary="true">IEEE Std 194-1977</docidentifier><docidentifier type="metanorma-ordinal">[B1]</docidentifier>
      ...
      <name language="en" script="Latn">International Electrotechnical Commission Technical Committee 66</name>
        ...
        <note type="Availability"><p id="_">IEEE Std 194-1977 has been withdrawn; however, copies can be obtained from Global Engineering, 15 Inverness Way East, Englewood, CO 80112-5704, USA, tel. (303) 792-2181 (http://global.ihs.com/).</p></note><language>en</language>
        <script>Latn</script>
    ...
    output = <<~OUTPUT
       <bibliography>
         <references id="_" normative="true" obligation="informative">
           <title id="_">Normative references</title>
           <p id="_">The following referenced documents are indispensable for the application of this document (i.e., they must be understood and used, so each referenced document is cited in text and its relationship to this document is explained). For dated references, only the edition cited applies. For undated references, the latest edition of the referenced document (including any amendments or corrigenda) applies.</p>
           <bibitem id="_" type="standard" anchor="ref11">
           ...
           <bibitem id="_" type="standard" anchor="ref31">
